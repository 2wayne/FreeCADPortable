...
user in an INI file next to FreeCADPortable.exe called FreeCADPortable.ini.
...
copy AppNamePortable.ini from this directory to FreeCADPortable.ini next to
FreeCADPortable.exe. The options in the INI file are as follows:
